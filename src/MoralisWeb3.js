...
import WalletConnectWeb3ConnectorElectron from './Web3Connector/WalletConnectWeb3ConnectorElectron';
...
class MoralisWeb3 {
  ...
  static getWeb3Connector(provider) {
    switch (provider) {
      ...
      case 'walletConnectElectron':
        return WalletConnectWeb3ConnectorElectron;
      case 'network':
